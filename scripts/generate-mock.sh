...
~/go/bin/mockgen -package=mails -self_package=github.com/skobelina/currency_converter/mocks/mails -source=./internal/mails/service.go -mock_names Service=MockSubscriberService -destination=./mocks/mails/mock.go
